type RenameKey<T, K extends keyof T, N extends string> = Pick<T, Exclude<keyof T, K>> &
  { [P in N]: T[K] }
...
const randomWait = () => new Promise<void>(resolve => setTimeout(resolve, Math.random() * 4000))
